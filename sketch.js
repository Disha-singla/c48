...
function setup(){
  ...
  //edgesprites
  p1=createSprite(220,300,10,100)
  p1.shapeColor="yellow"
  p2=createSprite(1200,300,10,100)
  ...
  b22.shapeColor="red"
  b23=createSprite(768,340,15,50)
  b23.shapeColor="green"
  b24=createSprite(900,300,50,15)
  b24.shapeColor="red"
  ...
  b35.shapeColor="red"
  b36=createSprite(1150,160,100,15)
  b36.shapeColor="blue"
  b37=createSprite(1020,60,350,15)
  b37.shapeColor="red"
